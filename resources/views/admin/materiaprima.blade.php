                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Matéria Prima</h2>
                                    ...
                                    <table class="table table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" width="8%">Código 1</th>
                                                <th scope="col" width="8%">Código 2</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr bgcolor="#f0f8ff">
                                                <td align="left">{{ $objeto->id }}</td>
                                                <td align="left">{{ $objeto->descricao }}</td>
                                                <td align="left">{{ $objeto->codigo1 }}</td>
                                                <td align="left">{{ $objeto->codigo2 }}</td>
