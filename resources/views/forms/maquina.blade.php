                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="{{ URL::asset('admin/maquina') }}" class="breadcrumb-link">{{ $pagina}}</a></li>
                                ...
                                {% endif %}-->
                                    ...
                                    <form method="post" id="basicform" action="{{ URL::asset('store')}}">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <input type="text" name="serial" class="form-control" placeholder="" value="{{$obj->serial}}" required id="id_setor">
                                        </div>
                                        <div class="form-group">
                                                <label for="">Ano</label>
                                                <input type="text" name="ano" class="form-control" placeholder="0000" value="{{$obj->ano}}" required id="id_setor">
                                        </div>
