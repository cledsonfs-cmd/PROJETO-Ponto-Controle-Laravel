                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="{{ URL::asset('materiaprima') }}" class="breadcrumb-link">{{ $pagina}}</a></li>
                               ...
                               <!--{% if messages %}
                                ...
                                {% endif %}-->
                                    ...
                                    <form method="post" id="basicform" action="{{ URL::asset('store')}}">
                                        @csrf
                                        <input type="hidden" name="tipo" value="materiaprima">
                                        <input type="hidden" name="id" value="{{$obj->id}}"> 

                                        <div class="form-group">
                                                <label for="">Descrição</label>
                                                <input type="text" name="descricao" class="form-control" placeholder="25 Caracteres" value="{{$obj->descricao}}" required id="id_descricao">
                                        </div>
                                        
                                        <div class="form-group">
                                                <label for="">Código 1</label>
                                                <input type="text" name="codigo1" class="form-control" placeholder="10 Caracteres (Opcional)" value="{{$obj->codigo1}}" id="id_codigo1">
                                        </div>
                                        
                                        <div class="form-group">
                                                <label for="">Código 2</label>
                                                <input type="text" name="codigo2" class="form-control" placeholder="10 Caractreres (Opcional)" value="{{$obj->codigo2}}" id="id_codigo2">
                                        </div>
