                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="{{ URL::asset('motivoreprogramacao') }}" class="breadcrumb-link">{{ $pagina}}</a></li>
                               ...
                               <!--{% if messages %}
                                ...
                                {% endif %}-->
                                    ...
                                    <form method="post" id="basicform" action="{{ URL::asset('store')}}">
                                        @csrf
                                        <input type="hidden" name="tipo" value="motivoreprogramacao">
                                        <input type="hidden" name="id" value="{{$obj->id}}"> 

                                        <div class="form-group">
                                                <label for="">Descrição</label>
                                                <input type="text" name="descricao" class="form-control" placeholder="200 Caracteres" value="{{$obj->descricao}}" required id="id_descricao">
                                        </div>
