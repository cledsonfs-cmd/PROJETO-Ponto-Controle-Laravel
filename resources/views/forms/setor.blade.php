                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="{{ URL::asset('setor') }}" class="breadcrumb-link">{{ $pagina}}</a></li>
                                ...
                                {% endif %}-->
                                    ...
                                    <form method="post" id="basicform" action="{{ URL::asset('store')}}">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <input type="text" name="codigo" class="form-control" placeholder="0000" value="{{$obj->codigo}}" required id="id_codigo">
                                        </div>
