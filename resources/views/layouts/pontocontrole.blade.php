                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav flex-column">
                        ...
                        <li class="nav-item">
                                                ...
                                                <ul class="nav flex-column">
                                                    <li class="nav-item">
                                                        @foreach ($links as $link)
                                                            @if ($link->v1 == $ano)                                                                
                                                                <a class="nav-link" href="{{ URL::asset('pontocontrole/'.$setor->id.'/'.$pontocontrole->id.'/'.$link->v3.'-01') }}">{{ $link->v2}}</a>      
                                                            @endif
                                                        @endforeach                                                        
                                                    </li>
                                                </ul>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ URL::asset('form/'.$tipo.'/'.$pontocontrole->id) }}"><i class="m-r-10 mdi mdi-note-plus-outline">&nbsp;&nbsp;Inserir Dados</i></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ URL::asset('pontocontrole_lista/'.$pontocontrole->id.'/'.date('Y-m-d')) }}"><i class="m-r-10 mdi mdi-file-find">&nbsp;&nbsp; Pesquisar Dados </i></a>
                            </li> 
                        <!--<li class="nav-item">
